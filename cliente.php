...
<body class="min-h-screen bg-gray-100 flex">
    <div class="w-64 bg-gray-200 p-4">
        ...
        <nav class="flex flex-col gap-4">
            ...
            <a href="#" class="flex items-center gap-2 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-300 hover:no-underline">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
    ...
    <div class="flex-1 p-6 bg-white">
        <header class="flex items-center justify-between border-b pb-4 mb-6">
            ...
            <div class="flex items-center gap-2">
                <input type="text" placeholder="Buscar clientes..." class="border rounded-md px-4 py-2">
            </div>
        </header>
